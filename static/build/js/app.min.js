/*! Made by Oliver Beattie. Built 2018-04-18 */
...
;return!0===b?(this._fragmentURI=e=f.substring(0,e.length)!==e?a(""):new a(f.substring(e.length)),e._parentURI=this,e):void 0!==b&&"string"!=typeof b?(this._fragmentURI=b,b._parentURI=b,this._parts.fragment=e+b.toString(),this.build(!d),this):("string"==typeof b&&(this._fragmentURI=void 0),c.call(this,b,d))},b.build=function(a){var b=d.call(this,a);return!1!==a&&this._parentURI&&this._parentURI.fragment(this),b},a}),function(){$(function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o;for(h=[],i="./static/images/location.png",a={lat:40.987684,lng:29.060062},n=[],n.push({lat:40.987914,lng:29.062032}),n.push({lat:40.985813,lng:29.05778}),g=new google.maps.Map($("#map")[0],{zoom:17,center:a,mapType:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!0,mapTypeControl:!0,zoomControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU,position:google.maps.ControlPosition.TOP_RIGHT},zoomControlOptions:{position:google.maps.ControlPosition.TOP_RIGHT}}),e=0,f=n.length;e<f;e++)k=n[e],new google.maps.Marker({position:k,map:g,icon:i});return d={mt:6378100,km:6378.1,mi:3963.1676,ft:20925524.9,in:251106299,yd:6975174.98,fa:3487587.49,na:3443.89849,ch:317053.408,rd:1268213.63,fr:31705.3408},j=function(){return this.setMap(null)},c=function(){var a,b,c;for(a=0,b=h.length;a<b;a++)c=h[a],c.setMap(null);return h=[]},b=function(a){var c,e,f,h;return f=$("#unitSelector"),h=$("option",f).eq(f[0].selectedIndex).val(),e=parseFloat(document.getElementById("radiusInput").value),e=e/d[h]*d.mt,c=new google.maps.Circle({center:a.latLng,clickable:!0,draggable:!1,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:g,radius:e,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),google.maps.event.addListener(c,"rightclick",j),google.maps.event.addListener(c,"click",b)},google.maps.event.addListener(g,"click",b),m=document.getElementById("searchInput"),$(m.form).on({submit:function(){return!1}}),l=new google.maps.places.SearchBox(m),google.maps.event.addListener(l,"places_changed",function(){var a;c(),null!=(a=l.getPlaces()[0])&&(null!=a.geometry.viewport?(g.fitBounds(a.geometry.viewport),g.panToBounds(a.geometry.viewport)):g.setCenter(a.geometry.location),h.push(new google.maps.Marker({position:a.geometry.location,map:g,title:a.name,clickable:!1})))}),o=function(){var a,b,c,d;return a=g.getCenter(),b={lat:_.round(a.lat(),6).toString(),lng:_.round(a.lng(),6).toString(),z:g.getZoom().toString(),u:$("#unitSelector").val(),r:$("#radiusInput").val()},b.r||delete b.r,d=new URI,d.setQuery(b),null!=(c=window.history)&&"function"==typeof c.replaceState?c.replaceState(null,null,d.toString()):void 0},google.maps.event.addListener(g,"bounds_changed",_.debounce(o,200)),google.maps.event.addListener(g,"zoom_changed",o),$("#unitSelector, #radiusInput").on("change",o),$(window).on("hashchange",function(a){var b,c,d,e,f;if(e=(new URI).query(!0),c=g.getCenter(),b=[c.lat(),c.lng()],d=[b[0],b[1]],null!=e.lat&&(d[0]=parseFloat(e.lat)),null!=e.lng&&(d[1]=parseFloat(e.lng)),0===$.grep(d,isNaN).length&&g.setCenter({lat:d[0],lng:d[1]}),null!=e.z&&(f=parseInt(e.z,10),isNaN(f)||g.setZoom(f)),null!=e.r&&$("#radiusInput").val(e.r),null!=e.u)return $("#unitSelector").val(e.u)}).triggerHandler("hashchange")})}.call(this);
